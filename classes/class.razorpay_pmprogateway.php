	...
	<tr class="pmpro_settings_divider gateway gateway_razorpay" <?php if( $gateway != "razorpay" ) { ?>style="display: none;"<?php } ?> >
		<td colspan="2">
			...
			<div class="notice notice-large notice-warning inline">
					<p class="pmpro_razorpay_notice">
						<strong><?php esc_html_e( 'Paid Memberships Pro: RazorPay is currently in Beta.', 'razorpay-pmpro' ); ?></strong><br />								
						<a href="https://www.paidmembershipspro.com/add-ons/razorpay/" target="_blank"><?php esc_html_e( 'Read the documentation on getting started with Paid Memberships Pro RazorPay &raquo;', 'razorpay-pmpro' ); ?></a>
					</p>
				</div>
		</td>
	</tr>
